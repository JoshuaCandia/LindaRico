...
const Slogan = () => {
  return (
    <div className='py-8 flex flex-col items-center'>
      <div>
        <h3 className='text-2xl'>Tu Seguridad, Nuestra Prioridad</h3>
      </div>
      <div className='text-sm flex flex-col text-center gap-4 py-4 px-2'>
        <p>
      ...
      <Button className='text-white rounded-md bg-blue-700 p-2'>
        Conocer más
      </Button>
    </div>
  );
